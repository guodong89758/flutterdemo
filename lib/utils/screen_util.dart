...
// class Gaps {
//   /// 水平间隔
//   static Widget hGap5 =  SizedBox(width: ScreenHelper.width(5));
//   static Widget hGap10 =  SizedBox(width: ScreenHelper.width(10));
//   static Widget hGap12 =  SizedBox(width: ScreenHelper.width(12));
//   static Widget hGap15 =  SizedBox(width: ScreenHelper.width(15));
//   static Widget hGap30 =  SizedBox(width: ScreenHelper.width(30));
//
//   /// 垂直间隔
//   static Widget vGap5  =   SizedBox(height: ScreenHelper.width(5));
//   static Widget vGap10 =  SizedBox(height: ScreenHelper.width(10));
//   static Widget vGap15 =  SizedBox(height: ScreenHelper.width(15));
//   static Widget vGap20 =  SizedBox(height: ScreenHelper.width(20));
//   static Widget vGap25 =  SizedBox(height: ScreenHelper.width(25));
//
