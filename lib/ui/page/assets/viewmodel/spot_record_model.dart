...
class SpotRecordModel extends ViewStateModel {
  ...
  SpotRecordModel() : super(viewState: ViewState.first);
  ...
  Future refresh() {
    page = 1;
    noMore = false;
    return getSpotRecord(page, pageSize);
  }
  ...
  Future getSpotRecord(int page, int size) {
