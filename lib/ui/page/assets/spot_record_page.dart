...
///现货资金记录
class SpotRecordPage extends StatefulWidget {
  const SpotRecordPage({Key? key}) : super(key: key);

  @override
  State<SpotRecordPage> createState() => _SpotRecordPageState();
}

class _SpotRecordPageState extends State<SpotRecordPage>
    with
        BasePageMixin<SpotRecordPage>,
        AutomaticKeepAliveClientMixin<SpotRecordPage> {
  final RefreshController _refreshController = RefreshController();
  late SpotRecordModel _model;
  ...
  Widget build(BuildContext context) {
    super.build(context);
    return ProviderWidget<SpotRecordModel>(
      model: _model,
      builder: (context, model, child) {
        ...
        return Scaffold(
          ...
          appBar: MyAppBar(
            title: S.current.asset_spot_record,
            bottomLine: true,
          ),
          body: Column(
            children: [
